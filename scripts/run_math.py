...
from src.hidden_state.data import MATH_SUBJECTS, load_math_records
...
def main() -> None:
    ...
    subjects = args.subjects if args.subjects else list(MATH_SUBJECTS)
